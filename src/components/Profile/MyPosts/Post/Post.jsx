...
const Post = (props) => (
  <div className={classes.item}>
    ...
    <div className={classes.like}>
      <img src='https://w7.pngwing.com/pngs/49/109/png-transparent-facebook-like-button-giphy-social-network-advertising-facebook-text-hand-rectangle-thumbnail.png' width='15' height='15' />
